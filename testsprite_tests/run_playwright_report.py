...
def apply_template_branding(template: str, *, live_banner: bool = False) -> str:
    ...
    html_out = template
    sub = (
        "<p class=\"title-subtitle\">Generated by <code>run_playwright_report.py</code> — Playwright (Chromium) and Python async tests against the served app. <strong id=\"live-status-banner\"></strong></p>"
        if live_banner
        else "<p class=\"title-subtitle\">Generated by <code>run_playwright_report.py</code> — Playwright (Chromium) and Python async tests against the served app.</p>"
    )
