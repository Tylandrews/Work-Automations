"""
TC028: Open Reports, close with X, main shell (call form) still usable.
"""
import asyncio
import os
...
async def run_test() -> None:
    ...
    try:
        ...
        await page.locator("#closeReportsModal").click()
        await expect(page.locator("#reportsModal")).to_be_hidden()

        await expect(app_shell).to_be_visible()
        await expect(page.locator("#callForm")).to_be_visible()
