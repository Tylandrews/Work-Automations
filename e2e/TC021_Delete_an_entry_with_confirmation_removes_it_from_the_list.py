"""
TC021: Create a row, open edit, delete, confirm — row disappears. Uses inline delete confirm in edit modal.
"""
import asyncio
import os
...
async def run_test() -> None:
    ...
    try:
        ...
        await page.locator("#organization").fill("TC021 Org")
        await page.locator("#mobile").fill("555-0210")
        await page.locator("#supportRequest").fill("Delete test")
        await page.locator("#ticketNumber").fill(e2e_notes_with_run_id(e2e_run_id, "TC021 delete"))
        ...
        await page.locator("#editModalDeleteConfirmBtn").click()
        await expect(page.locator("#editModal")).to_be_hidden(timeout=20000)

        await expect(entries).not_to_contain_text(MARKER, timeout=30000)
