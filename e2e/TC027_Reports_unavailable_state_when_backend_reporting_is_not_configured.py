"""
TC027: Reports overlay shows failure when call_reports / RPC is missing, or “No report yet” placeholders.

Passes if #reportsError is non-empty after load, or the grid shows the standard empty subtitles.
"""
import asyncio
import os
...
async def run_test() -> None:
    ...
    try:
        ...
        await expect(page.locator("#reportsModal")).to_be_visible(timeout=15000)
        ...
        assert degraded or healthy_cards, (
            "Expected a reporting error / empty placeholders, or four report cards when backend is healthy"
        )
