"""
TC022: Start delete, cancel confirm, close editor — entry still listed.
"""
import asyncio
import os
...
async def run_test() -> None:
    ...
    try:
        ...
        await page.locator("#organization").fill("TC022 Org")
        await page.locator("#mobile").fill("555-0220")
        await page.locator("#supportRequest").fill("Cancel delete")
        await page.locator("#ticketNumber").fill(e2e_notes_with_run_id(e2e_run_id, "TC022 cancel delete"))
        ...
        await page.locator("#editModalDeleteCancel").click()
        await expect(page.locator("#editModalDeleteConfirm")).to_have_attribute(
            "aria-hidden", "true"
        )
