...
- **Suggested command**: Which command to use (prefer: /normalize, /audit, /polish, /onboard, /clarify, /quieter, /adapt, /animate, /bolder, /distill, /optimize, /critique, /delight, /colorize, /harden, /extract — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /normalize, /audit, /polish, /onboard, /clarify, /quieter, /adapt, /animate, /bolder, /distill, /optimize, /critique, /delight, /colorize, /harden, /extract. You may also suggest other installed skills you're sure exist, but never invent commands.
